...
export default function Form() {
    ...
    return <div className="xl:pt-12 flex flex-col items-center xl:pb-96">
        <div className="w-full max-w-lg xl:max-w-[60rem] p-6 xl:bg-neutral-600 xl:bg-opacity-50 xl:rounded-xl xl:backdrop-blur-sm">
            ...
            <div className="flex flex-col xl:flex-row xl:space-x-6">
                ...
                <div className="grow xl:max-w-[10rem] mb-4">
                    <div className="relative flex flex-col justify-center">
            ...
            <div className="flex flex-col xl:flex-row">
                ...
                <div className="grow order-3">
                    <PrimaryButton className="w-full py-6 px-6 text-xl text-pink-100 w-1/2 shrink-0" disabled={false} onClick={() => {
                        setModal(<Attention />)
                    }}><>
