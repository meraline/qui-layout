        ...
        <Layout>
            <div className={`container mx-auto xl:pt-12 text-white flex flex-col`}>
                ...
                <div className="flex flex-col xl:flex-row gap-5 xl:align-strech mb-5 order-3 xl:order-2 -mx-6 xl:mx-0">
                    <div className="bg-neutral-700 xl:rounded-2xl xl:shadow shrink-0 pt-5 xl:w-[300px] shrink-0 pb-12 px-5 order-2 xl:order-1">
                        <div className="flex xl:block">
                            <div className="pr-2 xl:pr-0">
                                <div className="text-[24px] font-medium mb-3">Order details</div>
                                {[{
                                    title: `ID Number`,
                                    text: `99IEWW2GD`
                                }, {
                    ...
                    <div className="bg-neutral-700 xl:rounded-2xl xl:shadow grow p-5 xl:pb-12 bg-right bg-contain bg-no-repeat grid grid-cols-1 xl:grid-cols-2 gap-16  order-1 xl:order-2">
                        <div>
                            <div className="flex space-x-2 items-center mb-10">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                                    <rect width="26" height="26" rx="13" fill="#6CCA80" />
                                    <path d="M11.7851 15.1076C11.7656 15.1268 11.7343 15.1268 11.7148 15.1076L9.35029 12.7709C9.06372 12.4877 8.60265 12.4877 8.31608 12.7709C8.02468 13.0589 8.02468 13.5294 8.31608 13.8174L11.5039 16.9678C11.6402 17.1025 11.8596 17.1025 11.9959 16.9678L17.6836 11.3469C17.9752 11.0588 17.9751 10.588 17.6834 10.3C17.3968 10.0168 16.9357 10.0169 16.6491 10.3002L11.7851 15.1076Z" fill="#0A4A18" stroke="#0A4A18" strokeWidth="0.3" />
                                </svg>
                                <div className="text-2xl font-medium">Exchange completed</div>
                            </div>

                            <div className="mb-4">
                                <span className="text-stone-300 text-xl">Your succesfully swapped <br /></span>
                                <span className="text-violet-100 text-xl font-semibold">0.1231233 USDT</span>
                                <span className="text-stone-300 text-xl font-normal"> to </span>
                                <span className="text-violet-100 text-xl font-semibold">2,05 BTC</span>
                            </div>

                            <div className="text-stone-300 text-lg mb-4">We sincerely hope that you found the exchange process easy and would love to see you again. If our service met your expectations, we&quot;d greatly appreciate your rating on TrustPilot and/or BestChange. Your feedback helps us improve!</div>
                            <div className="flex items-end space-x-4">
                                <Image width="200" height="50" src={TrustPilot.src} className="w-40 h-auto" alt=""/>
                                <Image width={185} height={37} src={BestChange.src} className="w-40 h-auto"alt=""/>
                            </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 order-3 gap-5 mb-5 -mx-6 xl:mx-0">
                    <div className="bg-neutral-700 xl:rounded-2xl xl:shadow pt-5 pb-12 px-5">
                        <div className="text-2xl font-medium">Received transaction info</div>
                        <div className="flex-col gap-2.5 flex">
                            <div className="self-stretch grow shrink basis-0 flex-col gap-0.5 flex">
                            ...
                            <div className="flex-col gap-0.5 flex xl:border-b xl:border-white xl:border-opacity-5 pb-2">
                                <div className="text-neutral-400 ">Watch in blockchain</div>
                            ...
                            <div className="gap-10 inline-flex xl:border-b xl:border-white xl:border-opacity-5 pb-2">
                                <div className="">
                                    <div className="text-neutral-400 ">Receiving time</div>
                                    <div className="">
                                        <span className="text-white text-xl font-medium">13 minutes ago </span>
                                        <span className="text-neutral-400 text-xl">(15.11.2022 06:58:32)</span>
                                    </div>
                                </div>
                            </div>
                            <div className="gap-10 inline-flex xl:border-b xl:border-white xl:border-opacity-5 pb-2">
                                <div className="">
                                    ...
                                    <div className="">
                                        <span className="text-white text-xl font-medium">15 minutes ago </span>
                                        <span className="text-neutral-400 text-xl">(15.11.2022 04:13:29)</span>
                                    </div>
                                </div>
                            </div>
                            <div className="gap-10 inline-flex xl:border-b xl:border-white xl:border-opacity-5 pb-2">
                                <div className="">
                                    <div className="text-neutral-400 ">Confirmations</div>
                            ...
                            <div className="gap-10 inline-flex xl:border-b xl:border-white xl:border-opacity-5 pb-2">
                                <div className="">
                                    ...
                                    <div className="text-xl font-medium">16 USDT</div>
                                </div>
                            </div>
                            <div className="gap-10 inline-flex">
                                <div className="">
                                    <div className="text-neutral-400 ">Commission</div>
                                    <div className="text-xl font-medium">0,000221 ETH</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="bg-neutral-700 xl:rounded-2xl xl:shadow pt-5 pb-12 px-5">
                        <div className="text-2xl font-medium">Sent transaction info</div>
                        <div className="flex-col gap-2.5 flex">
                            <div className="self-stretch grow shrink basis-0 flex-col gap-0.5 flex">
                                <div className="text-neutral-400 ">TXID</div>
                                <div className="items-center gap-[7px] flex xl:flex">
                ...
                <div className="flex gap-5 align-strech mb-5 order-1 xl:order-3 -mx-6 xl:mx-0">
                    ...
                    <div className="w-[394px] shrink-0 bg-gradient-to-r from-fuchsia-800 to-pink-800 rounded-[14px] shadow px-6 py-8 hidden xl:block">
                        <div className="flex-col items-center gap-2 flex text-center mb-8">
                            <div className="text-2xl font-semibold">How’s your<br />experience so far?</div>
                ...
                <div className="-mx-6 px-6 py-4 xl:mx-0 xl:px-8 xl:py-8 bg-neutral-700 xl:rounded-2xl xl:shadow mb-5 order-5 xl:order-5">
                    <div className="text-2xl font-medium mb-6">You may like</div>
                    <Blog isHome={false} />
                </div>
            </div>
        </Layout>
