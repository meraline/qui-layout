        ...
        <Layout>
            <div className={`container mx-auto`}>
                <div className="flex flex-col justify-center items-center" >
                    <Image width={undefined} height={undefined} src={Image404.src} alt="" className="hidden xl:block max-w-none absolute top-0 pointer-events-none" />
                    <Image width={undefined} height={undefined} src={ImageM404.src} alt="" className="xl:hidden max-w-none absolute top-0 pointer-events-none -mt-60 ml-24" />
