                ...
                <div className={`container mx-auto text-white my-8 xl:my-16`}>
                    <div className="gap-12 xl:gap-36 flex-col flex mb-20">
                        <div className="gap-6 xl:gap-12 flex flex-col xl:flex-row">
                            <Image width={undefined} height={undefined} alt="" className="w-[422px] h-auto shrink-0 self-start" src={How1.src} />
                        ...
                        <div className="gap-6 xl:gap-12 flex flex-col xl:flex-row">
                            <Image width={undefined} height={undefined} alt="" className="w-[618px] h-auto shrink-0 xl:order-2 self-start" src={How2.src} />
                            <div className="flex-col gap-6 flex">
                        ...
                        <div className="gap-6 xl:gap-12 flex flex-col xl:flex-row">
                            <Image width={undefined} height={undefined} alt="" className="w-[634px] h-auto shrink-0 self-start" src={How3.src} />
                            <div className="flex-col gap-6 flex">
                        ...
                        <div className="gap-6 xl:gap-12 flex flex-col xl:flex-row">
                            <Image width={undefined} height={undefined} alt="" className="w-[618px] h-auto shrink-0 xl:order-2 self-start" src={How4.src} />
                            <div className="flex-col gap-6 flex">
                        ...
                        <div className="gap-6 xl:gap-12 flex flex-col xl:flex-row">
                            <Image width={undefined} height={undefined} alt="" className="w-[420px] h-auto shrink-0 self-start" src={How5.src} />
                            <div className="flex-col gap-6 flex">
